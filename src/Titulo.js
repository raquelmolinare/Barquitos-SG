...
export class Titulo extends THREE.Object3D {
    constructor(pos, tamLetra) {
        ...
        this.R = new Texto(positionR, 'R', tamLetra, Materiales.Matnegro, this.fontURL);
        this.Q = new Texto(positionQ, 'Q', tamLetra, Materiales.Matnegro, this.fontURL);
        this.U = new Texto(positionU, 'U', tamLetra, Materiales.Matnegro, this.fontURL);
        this.I = new Texto(positionI, 'I', tamLetra, Materiales.Matnegro, this.fontURL);
        this.T = new Texto(positionT, 'T', tamLetra, Materiales.Matnegro, this.fontURL);
        this.O = new Texto(positionO, 'O', tamLetra, Materiales.Matnegro, this.fontURL);
        this.S = new Texto(positionS, 'S', tamLetra, Materiales.Matnegro, this.fontURL);
